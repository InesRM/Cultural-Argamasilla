        ...
        <div class="p-6 bg-blue-50">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                <div class="bg-pink-50 rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    ...
                    <a href="{{ route('admin.users') }}" class="text-pink-900 font-medium text-lg hover:text-pink-400">Ver</a>
                </div>
                <div class="bg-pink-50 rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    ...
                    <a href="{{ route('admin.companies') }}" class="text-pink-900 font-medium text-lg hover:text-pink-400">Ver</a>
                </div>
                <div class="bg-pink-50 rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    <div class="flex justify-between mb-6">
                        <div>
                    ...
                    <a href="{{ route('admin.experiences') }}" class="text-pink-900 font-medium text-lg hover:text-pink-400">Ver</a>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <div class="bg-pink-50 rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    ...
                    <a href="{{ route('admin.events') }}" class="text-pink-900 font-medium text-lg hover:text-pink-400">Ver</a>
                </div>
                <div class="bg-pink-50 rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    <div class="flex justify-between mb-6">
                        <div>
