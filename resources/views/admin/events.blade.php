        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <div>
                <div class="flex items-center gap-x-3">
                    ...
                    <span class="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-200">{{$totalEvents}}
                        creados</span>
                </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-300 dark:bg-gray-700">
                                ...
                                <tr>
                                    <td class="px-3 py-4 text-sm font-medium whitespace-nowrap">
                                        <div>
                                            <h2 class="font-medium text-gray-800 dark:text-blue-300 ">
                                                {{$event->nombre}}
                                            </h2>
                                    ...
                                    <td class="px-3 py-4 text-sm whitespace-nowrap">
                                        <div>
                                            <p class="text-blue-300">{{$event->estado}}</p>
                                        </div>
                                    </td>
                                    <td class="px-3 py-4 text-sm whitespace-nowrap">
                                        <div>
                                    ...
                                    <td class="px-3 py-4 text-sm whitespace-nowrap">
                                        <div>
                                            <p class="text-blue-300">{{$event->categoria->nombre}}</p>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-3 py-4 text-sm whitespace-nowrap">
                                        <ul class="dropdown ml-3">
                                            ...
                                            <ul class="dropdown-menu shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-pink-900 border border-gray-100 w-full max-w-[140px]">
                                                ...
                                                <li>
                                                    <a href="{{route('admin.eventDetails', ['id' => $event])}}" class="flex items-center text-[13px] py-1.5 px-4 text-white hover:text-[#f84525] hover:bg-gray-50">Ver
                                                        detalles</a>
                                                </li>

                                                <li>
                                                    <a href="{{route('admin.eventInscriptions', ['id' => $event])}}" class="flex items-center text-[13px] py-1.5 px-4 text-white hover:text-[#f84525] hover:bg-gray-50">Ver
                                                        inscripciones</a>
                                                </li>
                                                ...
                                                <li>
                                                    <form method="POST" action="{{ route('admin.eventCancelation') }}">
                                                        ...
                                                        <button><a class="flex items-center text-[13px] py-1.5 px-4 text-white hover:text-[#f84525] hover:bg-gray-50" onclick="event.preventDefault();
                                                ...
                                                <li>
                                                    <a href="{{ route('admin.eventDelete', ['id' => $event]) }}" class="flex items-center text-[13px] py-1.5 px-4 text-white hover:text-[#f84525] hover:bg-gray-50">Eliminar</a>
                                                </li>
                                                <li>
                                                    <a href="{{route('admin.eventUpdateForm', ['id' => $event])}}" class="flex items-center text-[13px] py-1.5 px-4 text-white hover:text-[#f84525] hover:bg-gray-50">Modificar</a>
                                                </li>
                                            </ul>
                                        </ul>
                                    </td>
