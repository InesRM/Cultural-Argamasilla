                ...
                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                    <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900 text-white">
                                @foreach($empresas as $empresa)
                                <tr>
                                    <td class="px-3 py-4 text-sm font-medium whitespace-nowrap">
                                        <div>
                                            <h2 class="text-white">{{$empresa->nombre}}</h2>
                                        </div>
                                    </td>
                                    <td class="px-3 py-4 text-sm font-medium whitespace-nowrap">
                                        <div>
                                    ...
                                    <td class="px-3 py-4 text-sm whitespace-nowrap">
                                        <div>
                                            <p class="text-white">{{$empresa->web}}</p>
                                        </div>
                                    </td>
                                    <td class="px-3 py-4 text-sm whitespace-nowrap">
                                    ...
                                    <td class="px-3 py-4 text-sm whitespace-nowrap">
                                        <div>
                                            <a href="{{ route('admin.companyDelete', ['id' => $empresa]) }}" class="flex items-center text-[13px] py-1.5 px-4 text-white hover:text-[#f84525] hover:bg-gray-50">Eliminar Empresa</a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
